...
def _build_system_prompt(source_lang: str, target_name: str) -> str:
    ...
    Deterministic, firm instructions. Produces excellent translation
    quality with good context awareness. The retry mechanism handles
    any partial failures (which are DeepSeek server-side issues, not
    prompt-related).
    """
    return (
        f"/no_think\n"
